...
def dashboard():
    ...
    if forecast:
        ...
        # Distribute demand proportionally by zone capacity
    ...
    grid_risk = compute_grid_risk(zone_risks) if zone_risks else {
        ...
        "risk_level": "UNKNOWN", "n_critical_zones": 0, "n_high_zones": 0,
    }
    ...
    return {
        ...
        "forecast_preview": forecast[:6],    # next 6h for preview cards
